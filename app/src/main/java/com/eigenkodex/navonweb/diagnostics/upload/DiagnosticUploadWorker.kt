...
internal class DiagnosticUploadWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        ...
        val priorAttemptCount = inputData.getInt(KEY_PRIOR_ATTEMPTS, 0)
            .coerceIn(0, DiagnosticUploadPolicy.MAX_ATTEMPTS)
        val totalAttemptCount = priorAttemptCount + runAttemptCount
        if (!DiagnosticUploadPolicy.shouldAttempt(totalAttemptCount, age)) {
        ...
        val attempt = totalAttemptCount + 1
    ...
    internal companion object {
        ...
        const val KEY_PRIOR_ATTEMPTS = "diagnostic_prior_attempts"
